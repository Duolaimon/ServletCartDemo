...
<head>
    ...
    <script type="text/javascript">
        ...
        function sum(id) {
            ...
            window.location='<%=path%>/servlet/CartServlet?id='+id+'&num='+sum+'&action=add';
            alert("添加成功！");
        }
        function add()
        {
    ...
    <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <td width="70%" valign="top">
                ...
                <div id="cart">
                    <img src="images/buy_now.png"><a href="javascript:sum(<%=item.getId()%>)" ><img src="images/in_cart.png"></a><a href="servlet/CartServlet?action=show"><img src="images/view_cart.jpg"/></a>
                </div>
            </td>
            <%
                }
